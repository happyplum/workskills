...
Load this skill at conversation start and before meaningful actions, especially when urgency or familiarity makes it tempting to skip skill checks.

## Core Purpose

Skill checks happen before execution. Process discipline beats improvisation.
